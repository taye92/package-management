...
sudo wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.74/bin/apache-tomcat-9.0.74.zip
sudo tar -xvf apache-tomcat-9.0.74.zip
sudo rm apache-tomcat-9.0.74.zip
